...
export async function POST(request: NextRequest) {
 ...
 // Lead with strong full-body framing so flux doesn't crop to a half-body portrait.
  ...
  const STYLE =
    'Standing upright, arms hanging straight down at the sides, both hands fully visible with relaxed fingers, facing the camera. Photorealistic, soft studio lighting, clean plain neutral background.'
